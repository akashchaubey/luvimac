<template>
    ...
    <section class="lm-services bg section">
      <div class="container wd-container">
        <div class="row web-development flex-md-row-reverse">
            ...
            <div class="col-lg-6 col-md-6 col-12 d-flex align-items-center">
              <div class="ctn-box mt-5 mt-md-0">
                <div class="sec-title" data-aos="fade-down" data-aos-delay="50">
    ...
    <section class="lm-services bg section">
      <div class="container wd-container">
        ...
        <div class="row mobile-app-developement">
            ...
            <div class="col-lg-6 col-md-6 col-12">
                <div class="d-flex justify-content-center mt-4">
                    ...
                    <div class="technology-tools d-flex flex-column" data-aos="fade-down" data-aos-delay="50">
                        ...
                        <div class="technology-item">
                            <img src="/img/technology/tools/jira.png" alt="html">
                            <div class="technology-name">Jirs</div>
                        </div>
                    </div>
                </div>
            </div>
...
<style lang="scss" scoped>
  .get-started{
    position: relative;
    background:url(/img/about/get-started.jpg);
